...
export type MensajeWhereInput = {
  ...
  creado?: Prisma.DateTimeNullableFilter<"Mensaje"> | Date | string | null
  id_conversacion?: Prisma.IntFilter<"Mensaje"> | number
...
export type MensajeScalarWhereWithAggregatesInput = {
  ...
  creado?: Prisma.DateTimeNullableWithAggregatesFilter<"Mensaje"> | Date | string | null
  id_conversacion?: Prisma.IntWithAggregatesFilter<"Mensaje"> | number
}
...
export type MensajeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id_mensaje" | "rol" | "contenido" | "creado" | "id_conversacion", ExtArgs["result"]["mensaje"]>
...
export interface MensajeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const mensajeWithId_mensajeOnly = await prisma.mensaje.findMany({ select: { id_mensaje: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Mensajes and only return the `id_mensaje`
   * const mensajeWithId_mensajeOnly = await prisma.mensaje.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Mensajes and only return the `id_mensaje`
   * const mensajeWithId_mensajeOnly = await prisma.mensaje.updateManyAndReturn({
   *   select: { id_mensaje: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface MensajeFieldRefs {
  ...
  readonly creado: Prisma.FieldRef<"Mensaje", 'DateTime'>
  readonly id_conversacion: Prisma.FieldRef<"Mensaje", 'Int'>
}
